...
<div class="wrap">
  ...
  <div class="grid">
    ...
    <section class="card">
      <h3>CAN 远端上传</h3>
      <div class="kv"><div class="k">上传地址</div><div class="v mono" id="uploadUrl">--</div></div>
      <div class="kv"><div class="k">待打包帧数</div><div class="v" id="uploadPending">--</div></div>
      <div class="kv"><div class="k">批次序号</div><div class="v" id="uploadBatchSeq">--</div></div>
      <div class="kv"><div class="k">成功 / 失败</div><div class="v" id="uploadCounters">--</div></div>
      <div class="kv"><div class="k">最后 HTTP</div><div class="v" id="uploadHttp">--</div></div>
    </section>
